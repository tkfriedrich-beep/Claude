  ...
  return (
    <div className="mx-auto flex min-h-dvh max-w-xl flex-col justify-center px-5 py-10">
      <div className="mb-6 flex flex-col items-center text-center">
        ...
        <h1 className="mt-3 text-2xl font-bold tracking-tight">Set up your cockpit</h1>
        <p className="mt-1 text-[13.5px] text-muted">
          Local-first. Your data stays on this machine; nothing external runs without approval.
        </p>
      </div>

      <nav aria-label="Progress" className="mb-4 flex justify-center gap-2">
        {steps.map((label, i) => (
          <span
            key={label}
            className={`rounded-full px-3 py-1 text-[12px] font-medium ${
              i === step ? "bg-accent text-white" : i < step ? "bg-accent-soft text-accent" : "bg-line/50 text-muted"
            }`}
          >
            {i + 1}. {label}
          </span>
        ...
        <CardBody className="space-y-4 pt-5">
          ...
          {step === 1 ? (
            <>
              ...
              <div className="flex items-center justify-between rounded-[10px] border border-line bg-raised px-3.5 py-3">
                <div>
                  <p className="text-[13.5px] font-medium">Include demo data</p>
          ...
          {step === 2 ? (
            <>
              ...
              <div className="flex items-center justify-between rounded-[10px] border border-accent/30 bg-accent-soft/60 px-3.5 py-3">
                <div>
                  <p className="text-[13.5px] font-medium">Safe Mode</p>
                  <p className="text-[12.5px] text-muted">
